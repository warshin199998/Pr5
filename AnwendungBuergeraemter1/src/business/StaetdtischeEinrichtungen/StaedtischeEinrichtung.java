...
public class StaedtischeEinrichtung {
    ...
    public StaedtischeEinrichtung(String name, float geoeffnetVon, float geoeffnetBis,
    ...
    public String gibStaedtischeEinrichtungZurueck(char trenner){
